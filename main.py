...
cv2.createTrackbar("Area.Cross", "CONTROL", 0, 5000, nothing)
cv2.createTrackbar("Area.Square", "CONTROL", 0, 5000, nothing)
cv2.createTrackbar("Area.Circle", "CONTROL", 0, 5000, nothing)
...
while (True):
    ...
    sorce_imagem = cv2.imread("C:/Users/adm/Documents/EDRA-OPENCV/inputs/meus_inputs/8.jpg") # 3 0 0 87 2
    ...
    sliders7 = cv2.getTrackbarPos("Area.Cross", "CONTROL")          # resposável por exibir as formas geométricas de acordo com a área definida
    sliders8 = cv2.getTrackbarPos("Area.Square", "CONTROL")
    sliders9 = cv2.getTrackbarPos("Area.Circle", "CONTROL")
    #--------------------------------------------------------------------------------------------------------#
    ...
    findShapes(contours, gray_image_copy, sliders7, sliders8, sliders9)
